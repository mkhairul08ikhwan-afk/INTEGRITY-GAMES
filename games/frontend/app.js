...
function renderPrint() {
  ...
  const node = viewCard(
    ...
    `
      <div class="btn-row no-print">
        ...
        <button class="primary" data-action="print">PRINT</button>
      </div>
  ...
  qs('[data-action="print"]', node).addEventListener("click", () => window.print());
